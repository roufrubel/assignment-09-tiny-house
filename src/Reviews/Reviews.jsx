...
const Reviews = () => {
    return (
        <div className="md:flex lg:flex flex-grow justify-around gap-6 mt-8 mb-8">
            <div className="p-4 bg-slate-100 rounded-md mb-2">
